...
use crate::classic::klvm_tools::debug::{build_symbol_dump, FunctionExtraInfo};
...
use crate::classic::klvm_tools::stages::stage_2::reader::process_embed_file;
...
// Add an entry for main's arguments, named __chik__main_arguments in the
...
fn add_main_args(
    ...
    let entry_name = allocator.new_atom("__chik__main_arguments".as_bytes())?;
