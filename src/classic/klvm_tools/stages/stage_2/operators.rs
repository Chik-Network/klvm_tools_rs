...
use klvm_rs::run_program::run_program_with_pre_eval;
...
impl Dialect for CompilerOperatorsInternal {
    ...
    fn op(
        ...
        let extensions_to_klvmr_during_compile = self.get_operators_extension();
            ...
            SExp::Atom => {
                ...
                if opbuf == "_read".as_bytes() {
                    ...
                    self.base_dialect.op(
                        ...
                        sexp,
                        max_cost,
                        extensions_to_klvmr_during_compile,
                    )
                }
            }
