...
fn test_preprocessor_tours_includes_properly() {
    ...
    let expected_lines = &[
        "(defmac __chik__primitive__if (A B C) (qq (a (i (unquote A) (com (unquote B)) (com (unquote C))) @)))",
        "(defun __chik__if (ARGS) (a (i (r (r (r ARGS))) (com (qq (a (i (unquote (f ARGS)) (com (unquote (f (r ARGS)))) (com (unquote (__chik__if (r (r ARGS)))))) @))) (com (qq (a (i (unquote (f ARGS)) (com (unquote (f (r ARGS)))) (com (unquote (f (r (r ARGS)))))) @)))) @))",
        "(defmac if ARGS (__chik__if ARGS))",
        "(defun __chik__compile-list (args) (a (i args (com (c 4 (c (f args) (c (__chik__compile-list (r args)) ())))) (com ())) @))",
