...
// Test that we can test chiklisp outcomes in chiklisp.
#[test]
fn test_chiklisp_in_chiklisp_test_pos() {
    let compiled = do_basic_run(&vec![
        "run".to_string(),
        "-i".to_string(),
        "resources/tests".to_string(),
...
// Test that we can test chiklisp outcomes in chiklisp.
#[test]
fn test_chiklisp_in_chiklisp_test_neg() {
    let compiled = do_basic_run(&vec![
        "run".to_string(),
        "-i".to_string(),
        "resources/tests".to_string(),
...
#[test]
fn test_chiklisp_web_example() {
    let program = do_basic_run(&vec![
        "run".to_string(),
        "resources/tests/strict/chiklisp-web-example.clsp".to_string(),
    ]);
...
#[test]
fn test_chiklisp_web_example_defconst() {
    let program = do_basic_run(&vec![
        "run".to_string(),
...
#[test]
fn test_chiklisp_web_example_big_maybe() {
    let program = do_basic_run(&vec![
        "run".to_string(),
...
#[test]
fn test_chiklisp_web_example_map() {
    let program = do_basic_run(&vec![
        "run".to_string(),
...
#[test]
fn test_chiklisp_web_example_map_lambda() {
    let program = do_basic_run(&vec![
        "run".to_string(),
        "resources/tests/strict/map-example.clsp".to_string(),
    ]);
...
#[test]
fn test_chiklisp_web_example_embed() {
    let program = do_basic_run(&vec![
        "run".to_string(),
        "-i".to_string(),
        "resources/tests/strict".to_string(),
